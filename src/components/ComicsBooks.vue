<script>
import ComicBookThumbs from './ComicBookThumbs.vue';
...
<template>
    <div class="comics-books">
        <div class="thumb-container">
            <div class="row">
                <ComicBookThumbs v-for="(book, index) in books" :key="index" :imgUrl="book.thumb"
                    :title="book.series.toUpperCase()" />
            </div>
        </div>
    </div>
